...
use Concrete5\Community\Integration\Github\UserDataPopulator;
use OAuth\Common\Http\Exception\TokenResponseException;
use OAuth\OAuth2\Service\GitHub as GitHubService;
use OAuth\OAuth2\Token\TokenInterface;
use Symfony\Component\HttpFoundation\Response;

class Github extends AccountPageController
{
     ...
     *
     * @todo Actually vary the view when github is connected.
     */
    ...
    {
        if ($this->token->validate('github_connect', $token)) {
    ...
    public function handle_auth_response(): Response
    {
        ...
        $this->flash('message', t('Your GitHub acount has been attached!'));
    ...
    {
        return $this->resolverManager->resolve(['/account/github']);
    }

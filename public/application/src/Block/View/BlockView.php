<?php
/**
 * This class is loaded in `application/bootstrap/site.php`  and overrides the core BlockView class
 * This is patched from the 9.0.2 version of Concrete to fix the problem with third party view.js and
 * view.css files not loading. Without this member search looks weird and probably other stuff as well.
 *
 * @todo when we update to 9.0.2 remove this file and the override from bootstrap/start.php
 */
